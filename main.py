...
class Interface(AnchorLayout):
    ...
    def guardar_y_enviar(self):
        ...
        hoja["d32"]=self.ids.sobre1.text
        hoja["d33"]=self.ids.sobre2.text
        hoja["d34"]=self.ids.sobre3.text
        hoja["d35"]=self.ids.sobre4.text
        hoja["d36"]=self.ids.sobre5.text
        hoja["j32"]=self.ids.sobre6.text
        hoja["j33"]=self.ids.sobre7.text
        hoja["j34"]=self.ids.sobre8.text
        hoja["j35"]=self.ids.sobre9.text
        hoja["j36"]=self.ids.sobre10.text
        hoja["a38"]=self.ids.observaciones.text
